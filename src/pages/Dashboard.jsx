...
const Dashboard = () => {
  ...
  const expectedArrivals = bookings.filter(b => b.check_in === today && b.status !== 'Canceled');
  const expectedDepartures = bookings.filter(b => b.check_out === today && b.status !== 'Canceled');
        ...
        <header className="hidden lg:flex justify-between items-end mb-12 border-b border-white/5 pb-8">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-[10px] uppercase tracking-[0.4em] text-[#b1a494] font-black">Management Overview</span>
            </div>
