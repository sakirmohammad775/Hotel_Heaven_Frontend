  ...
  return (
    <div className="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden flex flex-col h-full transition-all">
      ...
      <div className="p-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h3 className="font-bold text-blue-600 tracking-wider text-sm uppercase">
            {title}
          </h3>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-slate-50/50">
              <th className="px-8 py-4 text-slate-400 uppercase text-[9px] font-bold tracking-[0.2em] border-b">
                ID
              </th>
              <th className="px-8 py-4 text-slate-400 uppercase text-[9px] font-bold tracking-[0.2em] border-b">
                Guest
              ...
              <th className="px-8 py-4 text-slate-400 uppercase text-[9px] font-bold tracking-[0.2em] border-b text-right">
                Status
              </th>
              <th className="px-8 py-4 text-slate-400 uppercase text-[9px] font-bold tracking-[0.2em] border-b text-center">
                Action
              </th>
            </tr>
          </thead>
