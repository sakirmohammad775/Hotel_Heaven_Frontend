      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white p-6">
        ...
        <div className="mt-8 overflow-hidden">
          <button
            ...
            className="border border-white px-8 py-3 text-[10px] uppercase tracking-widest translate-y-20 group-hover:translate-y-0 transition-transform duration-500 bg-white text-black"
          >
            Explore Hotel
          </button>
        </div>
